...
class CTBThreeOThree : public CPlugIn
{
public:
	...
	// Add your code here: ----------------------------------------------------------- //
	CBassLine m_TB303Oscillator; // or whatever you want to call it
	//CBassLine* m_pTB303Oscillator;
	
	//CBassLine* m_OSCFrequency;
	//CBassLine* m_OSCWaveform;

	void updateOscillator(bool bRecalc = true);
