...
*/
CTBThreeOThree::~CTBThreeOThree(void)
{
...
*/
bool __stdcall CTBThreeOThree::initialize()
{
	// Add your code here
...
*/
bool __stdcall CTBThreeOThree::prepareForPlay()
{
	// Add your code here:
	// initialize the BassLine object
	// I'll start, you finish the rest
	m_TB303Oscillator.setSampleRate((double)m_nSampleRate);
	m_TB303Oscillator.reset();
	updateOscillator();

	// finish, like homework
...
void CTBThreeOThree::updateOscillator(bool bRecalc)
{
	// I will do one line (the polyBlep button)
	m_TB303Oscillator.m_uPolyBLEP = m_uPolyBLEP;	

	// now you do the rest
	// update like the homework but you only need a few variables
	// ie we don't care about hard sync ratio, etc...
	m_TB303Oscillator.setOscFo(m_dOSCFrequency);
	m_TB303Oscillator.setWaveform(m_uOSCWaveform);

	if(bRecalc)
		m_TB303Oscillator.updateOscillator();
...
*/
bool __stdcall CTBThreeOThree::processAudioFrame(float* pInputBuffer, float* pOutputBuffer, UINT uNumInputChannels, UINT uNumOutputChannels)
{
	// this is done for you - nothing to add or change
	pOutputBuffer[0] = m_TB303Oscillator.doOscillate();
...
//
bool __stdcall CTBThreeOThree::userInterfaceChange(int nControlIndex)
{
	// you need to fill this in to do note on/off and updates, like the homework
		...
		case 1:
			{
				...
				if(m_uOSCWaveform == SAW303)
					m_TB303Oscillator.doOscillate();
				else if(m_uOSCWaveform == SQR303)
					 m_TB303Oscillator.doOscillate();
		...
		case 45:
			{
				...
				if(m_uNoteOn == SWITCH_ON)
					m_TB303Oscillator.startOscillator();
				else
					m_TB303Oscillator.stopOscillator();
				break;
			}
		case 46:
		{
			
			if(m_uPolyBLEP == SWITCH_ON)
			{
				m_TB303Oscillator.m_uPolyBLEP;	
				//break;
			}		
			else
				!m_TB303Oscillator.m_uPolyBLEP;
...
*/
bool __stdcall CTBThreeOThree::joystickControlChange(float fControlA, float fControlB, float fControlC, float fControlD, float fACMix, float fBDMix)
{
	// add your code here
...
*/
bool __stdcall CTBThreeOThree::processRackAFXAudioBuffer(float* pInputBuffer, float* pOutputBuffer,
...
*/
bool __stdcall CTBThreeOThree::processVSTAudioBuffer(float** inBuffer, float** outBuffer, UINT uNumChannels, int inFramesToProcess)
{
	...
	while (--inFramesToProcess >= 0)
	{
		...
		dOutput = m_TB303Oscillator.doOscillate();
...
bool __stdcall CTBThreeOThree::midiNoteOn(UINT uChannel, UINT uMIDINote, UINT uVelocity)
{
	return true;
}

bool __stdcall CTBThreeOThree::midiNoteOff(UINT uChannel, UINT uMIDINote, UINT uVelocity, bool bAllNotesOff)
{
	return true;
}

// uModValue = 0->127
bool __stdcall CTBThreeOThree::midiModWheel(UINT uChannel, UINT uModValue)
{
	return true;
}
...
bool __stdcall CTBThreeOThree::midiPitchBend(UINT uChannel, int nActualPitchBendValue, float fNormalizedPitchBendValue)
{
	return true;
}
...
*/
bool __stdcall CTBThreeOThree::midiClock()
{
...
bool __stdcall CTBThreeOThree::midiMessage(unsigned char cChannel, unsigned char cStatus, unsigned char
...
bool __stdcall CTBThreeOThree::initUI()
{
	// ADDED BY RACKAFX -- DO NOT EDIT THIS CODE!!! ------------------------------ //
...
// **--0xDEA7--**
	...
	ui0.nGUIRow = 1;
	ui0.nGUIColumn = 1;
	ui0.uControlTheme[0] = 0; ui0.uControlTheme[1] = 12; ui0.uControlTheme[2] = 0; ui0.uControlTheme[3] = 1; ui0.uControlTheme[4] = 0; ui0.uControlTheme[5] = 1; ui0.uControlTheme[6] = 0; ui0.uControlTheme[7] = 12632256; ui0.uControlTheme[8] = 0; ui0.uControlTheme[9] = 11119017; ui0.uControlTheme[10] = 1; ui0.uControlTheme[11] = 15790320; ui0.uControlTheme[12] = 1; ui0.uControlTheme[13] = 15790320; ui0.uControlTheme[14] = 0; ui0.uControlTheme[15] = 15790320; ui0.uControlTheme[16] = 15790320; ui0.uControlTheme[17] = 1; ui0.uControlTheme[18] = 15790320; ui0.uControlTheme[19] = 15790320; ui0.uControlTheme[20] = 0; ui0.uControlTheme[21] = 14; ui0.uControlTheme[22] = 0; ui0.uControlTheme[23] = 23; ui0.uControlTheme[24] = 54; ui0.uControlTheme[25] = 0; ui0.uControlTheme[26] = 0; ui0.uControlTheme[27] = 0; ui0.uControlTheme[28] = 0; ui0.uControlTheme[29] = 0; ui0.uControlTheme[30] = 0; ui0.uControlTheme[31] = 0; 
	...
	ui1.m_pUserCookedUINTData = &m_uOSCWaveform;
	ui1.cControlUnits = "                                                                ";
	ui1.cVariableName = "m_uOSCWaveform";
	ui1.cEnumeratedList = "SAW303,SQR303";
	...
	ui1.nGUIRow = 1;
	ui1.nGUIColumn = 2;
	ui1.uControlTheme[0] = 0; ui1.uControlTheme[1] = 12; ui1.uControlTheme[2] = 0; ui1.uControlTheme[3] = 1; ui1.uControlTheme[4] = 0; ui1.uControlTheme[5] = 1; ui1.uControlTheme[6] = 0; ui1.uControlTheme[7] = 12632256; ui1.uControlTheme[8] = 0; ui1.uControlTheme[9] = 11119017; ui1.uControlTheme[10] = 1; ui1.uControlTheme[11] = 15790320; ui1.uControlTheme[12] = 1; ui1.uControlTheme[13] = 15790320; ui1.uControlTheme[14] = 0; ui1.uControlTheme[15] = 15790320; ui1.uControlTheme[16] = 15790320; ui1.uControlTheme[17] = 1; ui1.uControlTheme[18] = 15790320; ui1.uControlTheme[19] = 15790320; ui1.uControlTheme[20] = 0; ui1.uControlTheme[21] = 14; ui1.uControlTheme[22] = 0; ui1.uControlTheme[23] = 122; ui1.uControlTheme[24] = 53; ui1.uControlTheme[25] = 0; ui1.uControlTheme[26] = 0; ui1.uControlTheme[27] = 0; ui1.uControlTheme[28] = 0; ui1.uControlTheme[29] = 0; ui1.uControlTheme[30] = 0; ui1.uControlTheme[31] = 0; 
	...
	ui2.m_pUserCookedUINTData = &m_uNoteOn;
	ui2.cControlUnits = "";
	ui2.cVariableName = "m_uNoteOn";
	ui2.cEnumeratedList = "SWITCH_OFF,SWITCH_ON";
	...
	ui3.m_pUserCookedUINTData = &m_uPolyBLEP;
	ui3.cControlUnits = "";
	ui3.cVariableName = "m_uPolyBLEP";
	ui3.cEnumeratedList = "SWITCH_OFF,SWITCH_ON";
